                      ...
                      <TableBody>
                        {transactions.map(tx => (
                          <TableRow key={tx.id}>
                            ...
                            <TableCell>{parseFloat(tx.quantity).toFixed(4)}</TableCell>
                            <TableCell>{parseFloat(tx.unit_price).toFixed(2)}</TableCell>
                            <TableCell>{parseFloat(tx.commission || 0).toFixed(2)}</TableCell>
                            <TableCell>{tx.currency}</TableCell>
                            <TableCell>{parseFloat(tx.exchange_rate || 1).toFixed(4)}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
